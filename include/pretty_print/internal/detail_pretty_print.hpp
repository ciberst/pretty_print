...
auto quoted_helper(const char* c) noexcept { return std::quoted(c); }

auto quoted_helper(const std::string& s) noexcept { return std::quoted(s); }
...
auto quoted_helper(std::string& s) noexcept { return std::quoted(s); }
